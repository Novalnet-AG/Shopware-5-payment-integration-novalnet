...
class PaymentNotification
{
    ...
    public function startProcess()
    {
        ...
        if ('SUCCESS' == $this->eventData['result']['status'] && 'FAILURE' != $this->eventData['transaction']['status'] && 'DEACTIVATED' != $this->eventData['transaction']['status'] && (!empty($this->orderReference) || $this->eventType == 'PAYMENT')) {
