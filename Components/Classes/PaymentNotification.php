...
class PaymentNotification
{
    ...
    private function transactionUpdate()
    {
        ...
        $upsertData['configuration_details'] = is_array($upsertData['configuration_details']) ? $this->helper->serializeData($upsertData['configuration_details']) : $upsertData['configuration_details'];
