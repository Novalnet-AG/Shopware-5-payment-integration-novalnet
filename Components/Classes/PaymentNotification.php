...
class PaymentNotification
{
    ...
    {
        $nnSid = $this->eventData['custom']['inputval1'] ? $this->eventData['custom']['inputval1'] : $this->eventData['custom']['payment_temporary_id'];
        ...
        if (empty($orderData['ordernumber']) && !empty($orderData)) {
            ...
            $this->setViews->message = 'Order is already updated. Order No: '. $orderData['ordernumber'];
            return;
        }
    }
