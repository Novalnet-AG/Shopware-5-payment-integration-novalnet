...
class NovalnetHelper
{
     ...
     * @var array
     */
    private $nnRedirectPayments = ['novalnetpaypal', 'novalnetonlinebanktransfer', 'novalnetideal', 'novalnetinstant', 'novalnetgiropay', 'novalnetprzelewy24', 'novalneteps', 'novalnetpostfinancecard', 'novalnetpostfinance', 'novalnetbancontact', 'novalnettrustly', 'novalnetalipay', 'novalnetwechatpay', 'novalnetblik'];
