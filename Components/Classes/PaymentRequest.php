...
class PaymentRequest
{
    ...
    public function getTransactionDetails($router, $uniquePaymentID, $currentPayment, $isRecurring = false)
    {
        ...
        $transactionData = [
            ...
            'system_version' => Shopware()->Config()->get('Version') . '-NN12.2.2',
        ...
        if (((in_array($currentPayment, $this->helper->getRedirectPayments())) || ($currentPayment == 'novalnetcc' && $sessionData['doRedirect'] == 1)) && !$isRecurring) {
