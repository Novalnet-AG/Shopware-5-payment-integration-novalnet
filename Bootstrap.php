...
use Shopware\Plugins\NovalPayment\Subscriber\Backend\Backend;
...
class Shopware_Plugins_Frontend_NovalPayment_Bootstrap extends Shopware_Components_Plugin_Bootstrap
{
    ...
    public function onDispatchLoopStartup(\Enlight_Event_EventArgs $args) {
        ...
        $this->get('events')->addSubscriber(new Backend($helper, $dataHandler, $requestHandler));
    ...
    public function addJsFiles()
    {
        return new ArrayCollection([
            $this->Path() . '/Views/frontend/_public/src/js/jquery.novalnet-applepay.js',
