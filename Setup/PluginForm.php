...
class PluginForm
{
    ...
    public function getPaymentForm()
    {
        ...
        $configElement = array(
            ...
            'novalnetsepainstalment_due_date' => array(
                'type' => 'number',
                'options' => array(
                    'label' => 'Fälligkeitsdatum (in Tagen)',
                    'minValue' => 2,
    ...
    public function getPaymentFormTranslations($form)
    {
        ...
        $translations = array(
            'en_GB' => array(
                ...
                'novalnetsepainstalment_due_date' => 'Payment due date (in days)',
        ...
        $descriptionTranslations = array(
            'en_GB' => array(
                ...
                'novalnetsepainstalment_due_date' => 'Number of days after which the payment is debited (must be between 2 and 14 days)',
