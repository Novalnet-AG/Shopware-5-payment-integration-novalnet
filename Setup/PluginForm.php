...
class PluginForm
{
    ...
    public function getPaymentForm()
    {
        ...
        $applePayButtonType = array(
            array('apple-pay-button-text-plain', array('en_GB' => 'Default', 'de_DE' => 'Standard')),
            array('apple-pay-button-text-buy', array('en_GB' => 'Buy', 'de_DE' => 'Kaufen')),
            array('apple-pay-button-text-donate', array('en_GB' => 'Donate', 'de_DE' => 'Spenden')),
            array('apple-pay-button-text-book', array('en_GB' => 'Book', 'de_DE' => 'Buchen')),
            array('apple-pay-button-text-contribute', array('en_GB' => 'Contribute', 'de_DE' => 'Beitragen')),
            array('apple-pay-button-text-check-out', array('en_GB' => 'Check out', 'de_DE' => 'Bezahlen')),
            array('apple-pay-button-text-order', array('en_GB' => 'Order', 'de_DE' => 'Bestellen')),
            array('apple-pay-button-text-subscribe', array('en_GB' => 'Subscribe', 'de_DE' => 'Abonnieren')),
            array('apple-pay-button-text-tip', array('en_GB' => 'Tip', 'de_DE' => 'Trinkgeld')),
            array('apple-pay-button-text-rent', array('en_GB' => 'Rent', 'de_DE' => 'Mieten')),
            array('apple-pay-button-text-reload', array('en_GB' => 'Reload', 'de_DE' => 'Aufladen')),
            array('apple-pay-button-text-support', array('en_GB' => 'Support', 'de_DE' => 'Unterstützen')),
        );
        
        $applePayButtonTheme = array(
            array('apple-pay-button-black-with-text', array('en_GB' => 'Dark', 'de_DE' => 'Dunkel')),
            array('apple-pay-button-white-with-text', array('en_GB' => 'Light', 'de_DE' => 'Hell')),
            array('apple-pay-button-white-with-line-with-text', array('en_GB' => 'Light-Outline', 'de_DE' => 'An Hintergrund anpassen'))
        );
        
        $applePayDisplayField = array(
        ...
        $configElement = array(
            ...
            'novalnetpaypal_shopping_type' => array(
                'type' => 'boolean',
                'options' => array(
                    'label' => 'Kauf mit einem Klick',
                    'position' => $position++,
    ...
    public function getPaymentFormTranslations($form)
    {
        ...
        $translations = array(
            'en_GB' => array(
                ...
                'novalnetapplepay_button_settings' => 'Button Design',
                'novalnetapplepay_button_type' => 'Button Type',
                'novalnetapplepay_button_theme' => 'Button Theme',
