...
class PluginForm
{
    ...
    public function getPaymentForm()
    {
        ...
        $instalmentCycles = array(
            ...
            array('36', array('en_GB' => '36 cycles', 'de_DE' => '36 Raten')),
        );
        ...
        $configElement = array(
            ...
            /* Blik configuration settings/options */
            'novalnetblik' => array(
                'type' => 'button',
                'options' => array(
                    'label' => 'Blik',
            ...
            'novalnetblik_after_paymenstatus' => array(
                'type' => 'select',
                'options' => array(
                    'label' => 'Status für abgeschlossene Zahlungen',
                    'position' => $position++,
            ...
            'novalnetblik_payment_notification_to_buyer' => array(
                'type' => 'text',
                'options' => array(
                    'label' => 'Benachrichtigung des Käufers',
                    'position' => $position++,
            ...
            /* Twint configuration settings/options */
            'novalnettwint' => array(
                'type' => 'button',
                'options' => array(
                    'label' => 'TWINT',
            ...
            'novalnettwint_after_paymenstatus' => array(
                'type' => 'select',
                'options' => array(
                    'label' => 'Status für abgeschlossene Zahlungen',
                    'position' => $position++,
            ...
            'novalnettwint_payment_notification_to_buyer' => array(
                'type' => 'text',
                'options' => array(
                    'label' => 'Benachrichtigung des Käufers',
                    'position' => $position++,
    ...
    public function getPaymentFormTranslations($form)
    {
        ...
        $translations = array(
            'en_GB' => array(
                ...
                'novalnetcashpayment_due_date' => 'Slip expiry date (in days)',
        ...
        $descriptionTranslations = array(
            'en_GB' => array(
                ...
                'novalnetcashpayment_due_date' => 'Number of days given to the buyer to pay at a store. If this field is left blank, 14 days will be set as slip expiry date by default',
