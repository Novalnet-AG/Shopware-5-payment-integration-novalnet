...
class Shopware_Controllers_Frontend_NovalPayment extends Shopware_Controllers_Frontend_Payment implements CSRFWhitelistAware
{
    ...
    {
        return ['return','cancel','status','deleteCard','getAvailableShipping','createApplePayOrder'];
    }
    ...
    public function processRequestAction()
    {
        ...
        $isRedirect = (in_array($this->paymentShortName, $this->helper->getRedirectPayments()) && $this->paymentShortName != 'novalnetpaypal') || ($this->paymentShortName === 'novalnetpaypal' && (empty($sessionData['paymentToken']) || $sessionData['paymentToken'] == 'new')) || ($this->paymentShortName === 'novalnetcc' && ($sessionData['doRedirect'] == 1));
        ...
        $params ['transaction']['test_mode'] = (int) $this->configDetails[$this->paymentShortName.'_test_mode'];
    ...
    {
        new PaymentNotification($this->Request()->getRawBody(), $this->View());
    }
