...
class Shopware_Controllers_Frontend_NovalPayment extends Shopware_Controllers_Frontend_Payment implements CSRFWhitelistAware
{
    ...
    public function cancelAction()
    {
        ...
        unset($this->session->novalnet['order_no'],$this->session->create_payment_ref);
    ...
    public function novalnetSaveOrder($novalnetResult, $postback = true)
    {
        ...
        unset($this->session->sComment, $this->session->novalnet, $this->session->nnCustomerComment, $this->session->novalnet_server_request,$this->session->create_payment_ref);
        $this->redirect(array(
            'controller' => 'checkout',
            'action' => 'finish',
            'sUniqueID' => $novalnetResult['tid']
