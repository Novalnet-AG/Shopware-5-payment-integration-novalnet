...
{if $payment_mean.name eq 'novalnetinvoiceGuarantee' || $payment_mean.name eq 'novalnetinvoiceinstalment' }
	<div class="novalnet-payments"
		...
		{if ($payment_mean.name eq 'novalnetinvoiceGuarantee' && $canShowDobField.novalnetinvoiceGuarantee == 'true') ||  ($payment_mean.name eq 'novalnetinvoiceinstalment' && $canShowDobField.novalnetinvoiceinstalment == 'true')}
			<div id="{$payment_mean.name}Form" class="{$payment_mean.name}DobField">
