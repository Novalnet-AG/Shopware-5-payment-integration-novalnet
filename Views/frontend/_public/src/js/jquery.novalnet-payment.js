...
(function ($) {
    ...
    $.plugin('novalnetPayments', {
        ...
        init: function () {
            ...
            $('#payment_mean'+document.getElementById('novalnetpayId').value).parent().parent().find('.method--label').hide();
        ...
        loadPaymentForm : function () {
            ...
            var me                  = this,
                ...
                radioSelector       = ( $('input[name="payment"]').length ) ? $('input[name="payment"]') : $('input[name="register[payment]"]') ,
                selectedPaymentId   = ( $('input[name="payment"]:checked').length ) ? $('input[name="payment"]:checked') : $('input[name="register[payment]"]:checked'),
                novalnetId          = $('#novalnetpayId'),
                checkPaymentType    = null,
                cookiePaymentVal    = self.getCookie('novalnet_payment_type') ? self.getCookie('novalnet_payment_type') : sessionStorage.getItem("novalnet_payment_type"),
                uncheckPayments     = true;
                
            if (selectedPaymentId != null && selectedPaymentId != undefined && ( selectedPaymentId.length ) ) {
            ...
            if (selectedPaymentId != undefined && novalnetId != undefined && novalnetId.val() == shopRadio) {
                ...
                checkPaymentType = cookiePaymentVal;
            }
            ...
            if (checkPaymentType != null && checkPaymentType != '' && novalnetId.val() == shopRadio) {
            ...
            paymentFormInstance.selectedPayment((data) => {
                ...
                sessionStorage.setItem("novalnet_payment_type", data.payment_details.type);
                ...
                if ($('form[name="frmRegister"]').length > 0 && $('input[name="register[payment]"]') != undefined && $('input[name="register[payment]"]:checked').val() != $('#novalnetpayId').val()) {
                    $('#payment_mean' + novalnetId.val()).trigger('click');
                }
            });
