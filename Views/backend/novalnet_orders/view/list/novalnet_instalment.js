	...
	createFieldSet: function () {
        ...
        actionColumItems.push({
            ...
            handler: function (grid, rowIndex, colIndex) {
	            ...
	            if ( (rec.get('reference') == '-' || rec.get('reference') == '') || (rec.get('amount') <= rec.get('refundedAmount') ) ){
                ...
                if (btn === 'yes') {
                    Ext.Ajax.request({
                        ...
                        params: {
                            ...
                            refund_amount : Ext.getCmp('instalment_partial_amount').getValue(),
                            refund_reason : Ext.getCmp('nn_refund_ref').getValue(),
