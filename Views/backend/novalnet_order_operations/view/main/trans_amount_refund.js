...
Ext.define('Shopware.apps.NovalnetOrderOperations.view.main.transAmountRefund', {
    ...
    createPartialRefundElements: function () {
        ...
        me.externalRefundAmountTextArea = Ext.create('Ext.form.field.Number', {
            ...
            itemId: 'nn_partial_refund_amount',
        ...
        me.externalButton = Ext.create('Ext.button.Button', {
            style: 'margin: 8px 0;',
            cls: 'small primary',
            name: 'nn_partial_refund',
            itemId: 'nn_partial_refund',
    ...
    nn_amount_refund: function () {
        ...
        var getvalnn = Ext.ComponentQuery.query('#nn_partial_refund_amount')[0].getValue();
                ...
                if (btn === 'yes') {
                    Ext.Ajax.request({
                        ...
                        params: {
                            ...
                            nn_partial_refund_amount : Ext.ComponentQuery.query('#nn_partial_refund_amount')[0].getValue(),
                            nn_refund_ref : Ext.ComponentQuery.query('#nn_refund_ref')[0].getValue()
                        },
                        ...
                        success: function (response) {
                            ...
                            if (decodedResponse.success) {
                                 Ext.ComponentQuery.query('#nn_partial_refund')[0].disable()
                            }
